...
\begin{titlepage}
  ...
  \begin{center}
    \Large 
Final thesis to obtain the academic degree\\
    \vspace{0.3cm}
    \Large \ThesisDegree   %%%%% >>>>> Bitte in TeXFiles/000_Settings eintragen 
  \end{center}
  \fi
  ...
  \ifdefined\ThesisLanguageIsEnglish 
  \begin{center}
    \Large submitted on \ThesisDeliveryDate\ \\   %%%%% >>>>> Bitte in TeXFiles/000_Settings eintragen
    \vspace{0.3cm}
    \Large \textbf{\myName}\\
    \vspace{0.3cm}
  ...
  \begin{center}
    ...
    \Large \textbf{\myName}\\
    \vspace{0.3cm}
    \normalsize Matriculation Number: \myStudentId   %%%%% >>>>> Bitte in TeXFiles/000_Settings eintragen
  \end{center}
  \fi
